...
M.Patterns = {
  -- Tags
  TagCharsOptional = "[%w\128-\2550-9_/-]*",
  TagCharsRequired = "[%w\128-\255]+[%w\128-\2550-9_/-]*[%w\128-\2550-9]+", -- assumes tag is at least 2 chars
  Tag = "#[%w\128-\255]+[%w\128-\2550-9_/-]*[%w\128-\2550-9]+",
